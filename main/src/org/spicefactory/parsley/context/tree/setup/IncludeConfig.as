...
/**
 * Represents a single configuration file that should be included to a parent configuration.
 */
public class IncludeConfig  
	...
	protected override function getElementProcessor () : ElementProcessor {
		if (_elementProcessor == null) {
			...
			ep.addAttribute("file", StringConverter.INSTANCE, true);
	...
	/**
	 * The name of the file to include (including path info).
	 */
