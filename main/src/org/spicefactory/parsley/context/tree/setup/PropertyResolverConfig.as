...
/**
 * Represents a <code>PropertyResolver</code> - in XML configuration the 
 * <code>&lt;property-resolver&gt;</code> tag. 
 * 
 * @author Jens Halm
 */
public class PropertyResolverConfig extends AbstractResolverConfig {
	 ...
	 */
	public function createInstance () : PropertyResolver {
		return type.newInstance([]) as PropertyResolver;
	}
