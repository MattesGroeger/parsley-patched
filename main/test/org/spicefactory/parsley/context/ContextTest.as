...
public class ContextTest {
	...
	[Test]
	public function getObjectIdsForInterface () : void {
		var context:Context = RuntimeContextBuilder.build([new InterfaceFactory(), new Object(), new Date()]);
		assertThat(context.getObjectIds(IEventDispatcher), arrayWithSize(1));
		assertThat(context.getObjectIds(Object), arrayWithSize(4));
	}
