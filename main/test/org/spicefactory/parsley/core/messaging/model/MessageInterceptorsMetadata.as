...
public class MessageInterceptorsMetadata extends MessageInterceptors {
	...
	[MessageInterceptor(type="org.spicefactory.parsley.core.messaging.TestEvent", selector="test1", order="1")]
	public override function event1 (processor:MessageProcessor) : void {
		super.event1(processor);
	}
	
	[MessageInterceptor(type="org.spicefactory.parsley.core.messaging.TestEvent", selector="test2", order="1")]
