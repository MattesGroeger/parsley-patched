<xsl:stylesheet 
  ...
  <xsl:template match="/package-listings">
	...
	<xsl:comment>
		asdocTitle = 'All Packages - <xsl:value-of select="$title" /> API';
		var baseRef = '';
		window.onload = configPage;
	</xsl:comment></script>
	<table style="display:none" id="titleTable" cellspacing="0" cellpadding="0" class="titleTable">
	<tr>
	<td align="left" class="titleTableTitle"><xsl:value-of select="$title" /> API</td><td align="right" class="titleTableTopNav"><a onclick="loadClassListFrame('all-classes.html')" href="class-summary.html">All Classes</a>&#160;|&#160;<a onclick="loadClassListFrame('index-list.html')" href="all-index-A.html">Index</a>&#160;|&#160;<a href="index.html?package-summary.html&amp;all-classes.html" id="framesLink1">Frames</a><a onclick="parent.location=document.location" href="" style="display:none" id="noFramesLink1">No&#160;Frames</a></td><td rowspan="3" align="right" class="titleTableLogo"><img alt="Adobe Logo" title="Adobe Logo" class="logoImage" src="images/logo.jpg"/></td>
	</tr>
  ...
  <xsl:template match="section">
    <xsl:if test="contains(@includeIn,$filter)">
