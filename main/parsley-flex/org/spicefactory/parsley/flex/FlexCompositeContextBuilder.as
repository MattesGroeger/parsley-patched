 ...
 * @author Jens Halm
 */
public class FlexCompositeContextBuilder extends CompositeContextBuilder {
	
	
	function FlexCompositeContextBuilder (viewTriggerEvent:String = "configureIOC", 
			parent:Context = null, domain:ApplicationDomain = null) {
		super(parent, domain);
