...
import org.spicefactory.parsley.core.view.handler.FastInjectHandler;
...
public class BootstrapDefaults {
	...
	public static function get config () : BootstrapConfig {
		if (!defaults) {
			...
			defaults.services.context.setImplementation(ChildContext);
			...
			defaults.viewSettings.addViewHandler(ContextCreationHandler);
